...
use DoctorBundle\Entity\Paciente;
use DoctorBundle\Form\PacienteType;
...
class PacienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DoctorBundle:Paciente')->findAll();

        return $this->render('DoctorBundle:Paciente:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('paciente_show', array('id' => $entity->getIdpaciente())));
        }

        return $this->render('DoctorBundle:Paciente:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DoctorBundle:Paciente')->find($id);
        ...
        return $this->render('DoctorBundle:Paciente:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DoctorBundle:Paciente:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new PacienteType(), $entity, array(
            'action' => $this->generateUrl('paciente_update', array('id' => $entity->getIdpaciente())),
            'method' => 'PUT',
        ));
